...
val md_theme_light_primaryContainer = Color(0xFFFFDF9B)
...
val md_theme_dark_onPrimaryContainer = Color(0xFFFFDF9B)
...
val bg_gr = Color(0xFFB39DDB)
val seed = Color(0xFFFFF4E4)