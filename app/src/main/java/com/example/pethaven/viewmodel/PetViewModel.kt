package com.example.pethaven.viewmodel

import android.util.Log
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.pethaven.model.data.PetResponse
import com.example.pethaven.model.data.SupabaseClientFactory
import com.example.pethaven.model.repository.PetRepository
            ...
            client.auth.sessionStatus.collect {
                when (it) {
                    is SessionStatus.Authenticated -> {
                        ...
                        _petUiState.value = PetUiState.Error("Get started by joining PetHaven!")
                    }
                }
            }
        }
